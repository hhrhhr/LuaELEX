...
function BinaryReader:char()  -- char
...
function BinaryReader:sint40(endian_big)  -- signed 40 bit integer
    local s40
    if endian_big then
        s40 =  string.unpack(">I5", self.f_handle:read(5))
    else
        s40 =  string.unpack("<I5", self.f_handle:read(5))
    end
    return s40
